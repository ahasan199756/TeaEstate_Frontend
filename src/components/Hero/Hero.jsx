...
const Hero = () => {
  ...
  return (
    <section className="relative bg-[#010801] pt-28 pb-16 px-4 md:px-10 lg:px-20 min-h-screen flex flex-col justify-center overflow-hidden">
        ...
        <div className="hidden lg:block lg:col-span-3 bg-black/30 backdrop-blur-3xl rounded-[32px] border border-white/10 overflow-hidden shadow-2xl self-start">
          ...
          <ul className="py-6 px-2">
            {categories.map((cat, i) => (
              <li
                key={i}
                className="px-6 py-3 text-white/60 hover:text-white hover:bg-emerald-500/10 rounded-2xl cursor-pointer flex justify-between items-center text-[11px] font-medium tracking-widest uppercase transition-all group"
              >
                {cat}
        ...
        <div className="lg:col-span-3 flex flex-col gap-6">
          <div className="flex-1 bg-gradient-to-br from-white/15 to-transparent backdrop-blur-2xl rounded-[40px] p-8 border border-white/10 relative group cursor-pointer overflow-hidden shadow-2xl">
            <div className="relative z-10">
              <div className="bg-emerald-500 text-black text-[9px] font-black px-3 py-1 rounded-full w-fit mb-4">
                BEST SELLER
              </div>
              <h3 className="text-2xl font-light text-white mb-6 tracking-tight leading-tight italic">
                Ceremonial <br />
                Grade Matcha
              </h3>
          ...
          <div className="flex-1 relative bg-black/60 backdrop-blur-md rounded-[40px] p-8 border border-emerald-500/20 group cursor-pointer hover:border-emerald-500/60 transition-all duration-1000 flex flex-col justify-between shadow-[0_0_30px_rgba(16,185,129,0.1)] hover:shadow-[0_0_50px_rgba(16,185,129,0.3)] overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="text-emerald-400 text-[9px] font-black uppercase tracking-[0.4em]">
                  Pure Affection
                </p>
              </div>
            ...
            <div className="relative z-10 mt-6">
              <p className="text-emerald-500 text-[10px] font-black tracking-[0.4em] flex items-center gap-3 group-hover:gap-5 transition-all duration-700">
                TAILOR YOUR GIFT{" "}
                <IoChevronForward className="group-hover:scale-125 transition-transform" />
              </p>
            </div>
      ...
      {/* --- TRUST FOOTER --- */}
      <div className="max-w-[1440px] mx-auto mt-20 w-full bg-white/[0.02] backdrop-blur-sm p-8 rounded-[32px] border border-white/5 relative z-20 overflow-hidden">
        {/* track */}
        <div className="flex w-max gap-8 items-center marquee-track">
          {/* 1st set */}
          {[
            {
            ...
            <div
              key={"a" + i}
              className="flex items-center gap-4 group cursor-default min-w-[260px]"
            >
              <div className="bg-emerald-500/10 p-3 rounded-2xl text-emerald-500 text-xl group-hover:bg-emerald-500 group-hover:text-black transition-all duration-500">
                {feat.icon}
              </div>
              <div>
